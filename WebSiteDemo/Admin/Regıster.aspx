              ...
              <div class="auth-form-light text-left p-5">
                ...
                <form runat="server" class="pt-3">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                         <input type="password" class="form-control form-control-lg" runat="server" id="txtPassword1" placeholder="Şifre"/>
                    </div>
                  <div class="mb-4">
                    <div class="form-check">
                      <label class="form-check-label text-muted">
                        <input type="checkbox" class="form-check-input"/> Okudum,Onaylıyorum</label>
                    </div>
                  </div>
                  <div class="mt-3">
                    <asp:Button ID="btnRegister1" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" runat="server" Text="KAYIT OL" OnClick="btnRegister" />
